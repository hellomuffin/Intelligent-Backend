...
from backend.api.yolov5.utils.general import (CONFIG_DIR, FONT, LOGGER, Timeout, check_font, check_requirements, clip_coords,
                           increment_path, is_ascii, threaded, try_except, xywh2xyxy, xyxy2xywh)
from backend.api.yolov5.utils.metrics import fitness
